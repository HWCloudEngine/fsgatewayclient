...
class CompletionCache(object):
    """The completion cache is how we support tab-completion with fsgatewayclient.
...
class SessionClient(adapter.LegacyJsonAdapter):
    ...
    def request(self, url, method, **kwargs):
        ...
        # keystoneclient, where we need to raise the fsgatewayclient errors.
...
class HTTPClient(object):
    USER_AGENT = 'python-fsgatewayclient'
...
def _construct_http_client(username=None, password=None, project_id=None,
                           ...
                           auth=None, user_agent='python-fsgatewayclient',
                           **kwargs):
    if session:
