...
from fsgatewayclient import client
from fsgatewayclient.v1_0 import certs
from fsgatewayclient.v1_0 import users
from fsgatewayclient.v1_0 import associations
from fsgatewayclient.v1_0 import versions
...
class Client(object):
    ...
    keystoneclient.session API::
        ...
        >>> from fsgatewayclient.client import Client
    ...
    def __init__(self, username=None, api_key=None, project_id=None,
        ...
        # NOTE(cyeoh): In the fsgatewayclient context (unlike Nova) the
